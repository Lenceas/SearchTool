...
namespace SearchTool
{
    ...
    public class EstateCertOCR
    {
        ...
        /// <returns></returns>
        public static OcrResModel Ocr1(string imageFileName)
        {
            try
            {
                ...
                var imgBase64 = ImgToBase64(imageFileName);
        ...
        /// <param name="imageFileName">图片路径</param>
        /// <returns></returns>
        public static OcrResModel Ocr2(string imageFileName)
        {
            try
            {
                if (string.IsNullOrEmpty(imageFileName))
        ...
        /// <param name="imageFileName">图片路径</param>
        /// <returns></returns>
        public static OcrResModel Ocr3(string imageFileName)
        {
            try
            {
                if (string.IsNullOrEmpty(imageFileName))
        ...
        /// <param name="imageFileName">图片路径</param>
        /// <returns></returns>
        public static OcrResModel Ocr4(string imageFileName)
        {
            try
            {
                if (string.IsNullOrEmpty(imageFileName))
